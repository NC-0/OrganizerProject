...
public interface CategoryDao {
	...
	String INSERT_CATEGORY_OBJECT = "INSERT INTO objects(parent_id,object_type_id,name,description) VALUES (NULL,4,?,NULL)";
	String INSERT_REF_TO_USER = "INSERT INTO objreference (attr_id,object_id,reference) VALUES ("+REF_ATTR+",?,?)";
